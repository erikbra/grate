...
";
    ...
    public string ResetIdentity(string schemaName, string tableName, long value) => $"ALTER TABLE [{TableWithSchema(schemaName, tableName)}] MODIFY ID GENERATED BY DEFAULT AS IDENTITY (START WITH LIMIT {value});";
}
