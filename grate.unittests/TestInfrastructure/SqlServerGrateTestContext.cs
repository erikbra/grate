...
class SqlServerGrateTestContext : TestContextBase, IGrateTestContext, IDockerTestContext
{
    ...
    public string ConnectionString(string database) => $"Data Source=localhost,{Port};Initial Catalog={database};User Id=sa;Password={AdminPassword};Encrypt=false;Pooling=true;Max Pool Size=1";
